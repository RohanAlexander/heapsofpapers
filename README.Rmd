...
- Option for save to AWS bucket (maybe can just use A's code and bring them in as a author?).
...
Please cite the package if you use it: Alexander, Rohan, and Annie Collins, 2021, 'heapsofpapers: Easily get heaps of papers' 7 March, https://github.com/RohanAlexander/heapsofpapers.
