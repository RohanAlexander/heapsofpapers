...
[![CRAN status](https://www.r-pkg.org/badges/version/heapsofpapers)](https://www.r-pkg.org/badges/version/heapsofpapers)
[![CRAN RStudio mirror downloads](https://cranlogs.r-pkg.org/badges/grand-total/heapsofpapers?color=blue)](https://r-pkg.org/pkg/heapsofpapers)
<!-- badges: end -->
...
Here is an example of getting two papers from [SocArXiv](https://osf.io/preprints/socarxiv), using the main function `heapsofpapers::get_and_save()`:
