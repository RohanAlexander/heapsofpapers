...
Let's say that you already had those PDFs, but weren't sure. You could use check_for_existence to check
...
Please cite the package if you use it: Alexander, Rohan, Annie Collins, and A Mahfouz, 2021, 'heapsofpapers: Easily get heaps of papers' 13 March, https://github.com/RohanAlexander/heapsofpapers.
